...
\begin{frame}{Networking in Rust}
    ...
    \enote{
        ...
        \begin{enumerate}
            ...
            \item There are also mutable references: Only one is allowed at the same time
            \item Useful when working with network applications (prevents the occurence of data races if a thread tries
