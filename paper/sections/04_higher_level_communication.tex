...
the \rust{struct} called \rust{Data} in Figure \ref{data-struct}, which will both be implemented in the HTTP client and
server.
...
Finally the extracted \rust{Data} instance can be mapped to a response, which in result can be sent back to the client.
